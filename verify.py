...
_url = 'https://westus.api.cognitive.microsoft.com/face/v1.0/verify'
...
# pathToFileInDisk = r'/Users/shubhankarmohapatra/faceapi/me.jpg'
...
data = {"faceId1": "e87bf915-3ea3-4706-9ae7-12d584e4f88b" ,
        "faceId2": "db0e8041-9c29-46ef-9ff1-6258e65a3d7e"}

# data= '{"faceId1":"e87bf915-3ea3-4706-9ae7-12d584e4f88b","faceId2":"e87bf915-3ea3-4706-9ae7-12d584e4f88b" }'

response = requests.request( 'post', _url, json = data, headers = headers )
print(response)
